            ...
            <div className="flex flex-col w-2/5 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col self-stretch mb-20 my-auto max-md:mt-10">
                ...
                <div className="mt-10 text-lg text-white">
                  ...
                  and hotels from over 10,000 partners.
                </div>
                <div className="flex flex-col pr-2.5 pl-1 mt-7">
                  <small className="text-sm text-white">
                    *Partners are vetted and approved prior to being placed
                  </small>
                  <button className="self-start px-3 py-2.5 mt-6 text-base font-semibold text-center text-black bg-amber-400 rounded-xl">
                    Get in Touch
                  </button>
                </div>
              </div>
