            ...
            <div className="w-full px-4">
              <div className="shadow-three mx-auto max-w-[500px] rounded bg-gray-400 px-6 py-10 dark:bg-dark sm:p-[60px]">
                ...
                <p className="mb-11 text-center text-base font-medium text-body-color">
                  Login to your account for better expense tracking.
                </p>
                ...
                <form>
                  ...
                  <div className="mb-8 flex flex-col justify-between sm:flex-row sm:items-center">
                    <div className="mb-4 sm:mb-0 border-solid">
                      <label
                      ...
                      >
                        <div className="relative">
                          <input
                            ...
                            className="sr-only"
                          />
                          <div className="box mr-4 flex h-5 w-5 items-center justify-center rounded border border-solid  dark:border-white dark:border-opacity-10">
